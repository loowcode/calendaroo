...
class CalendarUtils {
  static SplayTreeMap<Date, List<EventInstance>> toMap(List<EventInstance> events) {
  ...
  static void _insertIntoMap(
      SplayTreeMap<DateTime, List<EventInstance>> map, DateTime date, EventInstance event) {
